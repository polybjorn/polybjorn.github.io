...
writeFileSync(join(DIST_NO, 'README.md'), `# [polybjorn.no](https://polybjorn.no)

Personal portfolio and contact point — who I am, what I do, where to find my work, and how to reach me.

Bilingual — Norwegian at [polybjorn.no](https://polybjorn.no), English at [polybjorn.com](https://polybjorn.com). This repo is a deploy target — source code lives in [polybjorn/polybjorn-en](https://github.com/polybjorn/polybjorn-en).
